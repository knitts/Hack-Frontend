      ...
      <section class="relative h-screen max-w-7xl w-full -mt-20 lg:w-4/5 mx-auto px-6 text-gray-100 body-font ">
        <div class="container h-full content-center flex flex-wrap mx-auto items-center justify-center align-middle items-center ">
          ...
          <div className="w-full md:w-1/2 mt-16 items-center bg-gray-900 bg-opacity-80 shadow px-20 pt-16 pb-20 rounded-lg">
            ...
            <input className="mt-8 my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" placeholder="Enter League name"/>
            <input className="my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" type="number" placeholder="Entry fee for registering players (in ETH)"/>
            <input className="my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" type="number" placeholder="Max number of players allowed"/>
            <input className="my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" type="number" placeholder="Duration of the League (in days)"/>
            {/* <Link to="/Dashboard"> */}
